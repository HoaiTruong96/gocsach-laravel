...
<head>
    ...
    <style>
        ...
        body { font-family: 'Roboto', sans-serif; background-color: #f3f4f6; } /* Nền xám nhẹ cho nổi bật khối nội dung */
    </style>
</head>
    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-6 text-sm font-medium uppercase text-gray-700">
                ...
                <a href="/profile" class="text-blue-600 border-b-2 border-blue-600 pb-1">Tài Khoản</a>
            </nav>
        </div>
    </header>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-sm p-6 text-center border border-gray-100 sticky top-24">
                    <div class="relative w-32 h-32 mx-auto mb-4">
                        <img src="https://ui-avatars.com/api/?name={{ $user->name ?? 'User' }}&background=0D8ABC&color=fff&size=128" 
                             alt="Avatar" 
                    ...
                    <h2 class="text-xl font-bold text-gray-800">{{ $user->name ?? 'Tên Thành Viên' }}</h2>
                    <p class="text-gray-500 text-sm mb-4">{{ $user->email ?? 'email@example.com' }}</p>
                    ...
                    <button class="w-full border border-gray-300 text-gray-600 py-2 rounded-lg font-medium hover:bg-gray-50 transition">
