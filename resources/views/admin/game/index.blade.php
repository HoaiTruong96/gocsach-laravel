    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-1 inline-flex">
            ...
            <button onclick="showTab('challenges')" id="tab-challenges"
                class="tab-btn px-6 py-2 rounded-lg font-medium transition-all text-gray-600 hover:bg-gray-100">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-6">
                        ...
                        <form action="{{ route('admin.badges.store') }}" method="POST">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Icon (emoji hoặc
                                        URL)</label>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label for="badge_active" class="ml-2 text-sm text-gray-700">Kích hoạt</label>
                                </div>
                                <button type="submit"
                            ...
                            <tbody class="divide-y divide-gray-100">
                                @forelse($badges as $badge)
                                    <tr class="hover:bg-gray-50 group">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-xs text-gray-500">{{ Str::limit($badge->description, 50) }}
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 text-center">
                                            <span class="bg-purple-100 text-purple-600 px-2 py-1 rounded text-xs font-bold">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            @if($badge->is_active)
                                                <span class="bg-green-100 text-green-600 px-2 py-1 rounded text-xs font-bold">Hoạt
                                                    động</span>
                                            @else
                                                <span
                                                    class="bg-gray-100 text-gray-500 px-2 py-1 rounded text-xs font-bold">Tắt</span>
                                            @endif
                                        </td>
                        ...
                        <form action="{{ route('admin.challenges.store') }}" method="POST">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label for="challenge_active" class="ml-2 text-sm text-gray-700">Kích hoạt</label>
                                </div>
                                <button type="submit"
                                    ...
                                    <div class="flex items-start justify-between">
                                        <div class="flex-1">
                                            <div class="flex items-center gap-2 mb-1">
                                                <h4 class="font-semibold text-gray-800">{{ $challenge->name }}</h4>
                                                @if($challenge->isOngoing())
                                                    <span
                                                        class="bg-green-100 text-green-600 px-2 py-0.5 rounded text-xs font-bold">Đang
                                                        diễn ra</span>
                                                @elseif($challenge->end_date < now())
                                                    <span class="bg-gray-100 text-gray-500 px-2 py-0.5 rounded text-xs font-bold">Đã
                                                        kết thúc</span>
                                                @else
                                                    <span
                                                        class="bg-blue-100 text-blue-600 px-2 py-0.5 rounded text-xs font-bold">Sắp
                                                        diễn ra</span>
                                                @endif
                                            </div>
                                            <p class="text-sm text-gray-500 mb-2">{{ $challenge->description }}</p>
