    ...
    <div
        ...
        <div class="flex items-center gap-4 mb-6 pb-5 border-b border-gray-100 dark:border-slate-700">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-slate-400">{{ $author->slug }}</p>
            </div>
        </div>
        ...
        <form action="{{ route('admin.authors.update', $author->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-5">
                ...
                {{-- Ảnh --}}
                <div>
                    <label class="block text-sm font-bold text-gray-700 dark:text-slate-300 mb-2">Thay đổi ảnh</label>
                    ...
                    <div id="preview-section" class="hidden mb-3">
                        <div
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-green-700 dark:text-green-300">Ảnh mới sẵn sàng</p>
                                <button type="button" onclick="clearCroppedImage()"
                                    class="text-xs text-red-500 hover:underline">Hủy</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        @include('admin.partials.custom-pickers', ['type' => 'year', 'name' => 'birth_year', 'value' => old('birth_year', $author->birth_year), 'placeholder' => 'Chọn...'])
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-gray-700 dark:text-slate-300 mb-2">Năm mất</label>
                        @include('admin.partials.custom-pickers', ['type' => 'year', 'name' => 'death_year', 'value' => old('death_year', $author->death_year), 'placeholder' => 'Còn sống...'])
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative" id="nationality-wrapper">
                        <input type="text" name="nationality" id="nationality-input"
                            value="{{ old('nationality', $author->nationality) }}" autocomplete="off"
