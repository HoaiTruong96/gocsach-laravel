...
@section('title', 'Trang Ch? - Góc Sách')
...
@section('content')
                        ...
                        <div class="w-full md:w-7/12 text-center md:text-left space-y-6">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start pt-2">
                                ...
                                <a href="{{ $link }}"
                                    ...
                                    <span>Ð?c review</span> <i class="fas fa-arrow-right text-sm"></i>
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div class="flex justify-between items-end mb-8">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-1">Góc nhìn sâu s?c v? sách và cu?c s?ng</p>
                            </div>
                        </div>
                        <a href="#"
                        ...
                        @if(isset($featuredArticle))
                            <article class="md:col-span-3 group cursor-pointer relative"
                                ...
                                @if(Auth::check() && Auth::user()->isAdmin())
                                    {{-- Nút s?a (Ngan ch?n click bong bóng d? không nh?y trang) --}}
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 relative gap-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">Nh?ng bài review hay nh?t t? c?ng d?ng</p>
                                </div>
                            </div>
                            ...
                            <div class="slider-reviews flex gap-4 sm:gap-5 overflow-x-auto scroll-smooth no-scrollbar pb-4">
                                @foreach($latestPosts as $index => $post)
                                    @php
                                        ...
                                        $emptyStars = 5 - $fullStars - ($hasHalfStar ? 1 : 0);
                                        $isNew = $index < 3; // 3 bài d?u hi?n NEW
                                    @endphp
                            ...
                            <div class="slider-reviews flex gap-4 sm:gap-5 overflow-x-auto scroll-smooth no-scrollbar pb-4">
                                @foreach($hotPosts as $index => $post)
                                    @php
                                        ...
                                        $hasHalfStar = ($rating - $fullStars) >= 0.5;
                                        $emptyStars = 5 - $fullStars - ($hasHalfStar ? 1 : 0);
                                        $isHot = $index < 3; // 3 bài d?u hi?n HOT
                                    @endphp
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Nh?ng t?a sách m?i nh?t trong thu vi?n</p>
                            </div>
                        </div>
                        ...
                        <div id="sliderNewBooks" class="flex gap-5 overflow-x-auto scroll-smooth no-scrollbar pb-4"
                            ...
                            @else
                                <div
                                    ...
                                    <p class="font-medium">Chua có sách m?i trong thu vi?n.</p>
                                    <a href="{{ route('books.list') }}"
                ...
                <section id="community-posts" class="mb-16 scroll-mt-24">
                    <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                        <div class="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">Góc chia s? c?m nh?n t? d?c gi?</p>
                                </div>
                            </div>
                        ...
                        <div id="comments-container"
                            ...
                            {{-- N?I DUNG AJAX S? Ð? VÀO ÐÂY --}}
                            <div id="comments-content-wrapper">
                                {{-- [ÐÃ S?A]: Truy?n bi?n latestReviews --}}
                    ...
                    <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                        <div class="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl md:text-3xl font-serif font-bold mb-2 text-brand-beige">Th? Thách Ð?c
                                    Sách 2025</h3>
                                <p class="text-white/70 text-sm font-light max-w-md leading-relaxed">
                                    <i class="fas fa-medal text-yellow-400 mr-1"></i>
                                    Hoàn thành <span class="text-brand-accent font-bold">3 cu?n sách</span> d? nh?n huy hi?u
                                    "M?t Sách C?n Cù" và nhi?u ph?n thu?ng h?p d?n!
                                </p>
                            </div>
                        </div>
            ...
            <div class="lg:col-span-4">
                <div class="space-y-6 sm:space-y-8">
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between mb-5 relative">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 class="font-serif font-bold text-gray-800 text-base leading-none">Hôm nay d?c gì?
                                        </h3>
                                        <span class="text-xs text-gray-400">G?i ý cho b?n</span>
                                    </div>
                                </div>
                                <a href="{{ route('home') }}"
                                    class="text-xs text-purple-500 hover:text-purple-700 font-bold flex items-center gap-1"
                                    title="Ð?i sách khác vào ngày mai">
                    ...
                    {{-- Widget 1: Top Th?nh Hành - Redesigned --}}
                    <div
                        ...
                        <div class="flex items-center justify-between mb-6 relative">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 class="font-serif font-bold text-lg text-gray-800 leading-none">Top Th?nh Hành</h3>
                                    <span class="text-xs text-orange-600 font-medium">?? Ðu?c d?c nhi?u nh?t</span>
                                </div>
                            </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3 mb-4 relative">
                            ...
                            <div>
                                <h3 class="font-serif font-bold text-gray-800 leading-none">Th? Lo?i Sách</h3>
                                <span class="text-[10px] text-gray-400">Khám phá theo s? thích</span>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-2 relative">
                            @if(isset($categories) && $categories->count() > 0)
                                ...
                                @endforeach
                            @else
                                <span class="text-sm text-gray-400 italic">Ðang c?p nh?t...</span>
                            @endif
                        </div>
                    ...
                    {{-- Widget 3: Liên K?t Mua Sách - Redesigned --}}
                    <div
                        ...
                        <div class="flex items-center gap-3 mb-4 relative">
                            ...
                            <div>
                                <h3 class="font-serif font-bold text-gray-800 leading-none">Mua Sách Giá T?t
                                </h3>
                                <span class="text-[10px] text-gray-400">Ð?i tác uy tín</span>
                            </div>
                        </div>
                    ...
                    {{-- Widget: Th?ng Kê C?ng Ð?ng - Light Style --}}
                    @if(isset($communityStats))
                        <div
                            ...
                            <div class="flex items-center gap-3 mb-4 relative">
                                ...
                                <div>
                                    <h3 class="font-serif font-bold text-gray-800 leading-none">Th?ng Kê</h3>
                                    <span class="text-[10px] text-gray-400">S? li?u c?a Góc Sách</span>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-2 relative">
                                <div
                                    ...
                                    <div class="text-[10px] text-gray-500 uppercase font-medium">Cu?n sách</div>
                                </div>
                                <div
                                    class="bg-white/80 backdrop-blur-sm rounded-xl p-3 text-center border border-white hover:border-blue-200 hover:shadow-md transition-all group">
                                ...
                                <div
                                    ...
                                    <div class="text-[10px] text-gray-500 uppercase font-medium">Ðánh giá</div>
                                </div>
                                <div
                                    class="bg-white/80 backdrop-blur-sm rounded-xl p-3 text-center border border-white hover:border-blue-200 hover:shadow-md transition-all group">
                                    ...
                                    <div class="text-[10px] text-gray-500 uppercase font-medium">Bình lu?n</div>
                                </div>
                            </div>
                        </div>
                    @endif
    ...
    {{-- Ðã chuy?n Th?ng kê c?ng d?ng lên sidebar --}}
    {{-- Ðã chuy?n Th?ng kê c?ng d?ng lên sidebar --}}
...
@push('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // --- LOGIC CU?N XU?NG VÀ HIGHLIGHT COMMENT/REPLY T? THÔNG BÁO ---
        ...
        // --- 2. HÀM ÐI?U KHI?N GIAO DI?N (TOGGLE) ---
        ...
        function loadComments(urlOrSortType) {
            ...
            // Cáº­p nháº­t UI tab ngay láº­p tá»©c
        ...
        function submitComment(postId, parentId = null, event) {
            ...
            if (!currentUserId) { alert("Vui lòng dang nh?p!"); window.location.href = "/login"; return; }
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        countLabels.forEach(el => {
                            el.innerText = `Bình lu?n (${data.new_count})`;
                        });
                                            ...
                                            <div id="reply-section-${data.comment.id}" class="hidden mt-3 space-y-4 border-l-2 border-gray-100 pl-4 animate-fade-in">
                                                <div class="flex gap-2 relative mt-2">
                                                    <textarea id="reply-input-${data.comment.id}" rows="1" 
                                                              ...
                                                              placeholder="Nh?p câu tr? l?i..."></textarea>
        ...
        // --- 4. HÀM ÐI?U KHI?N BÀI REVIEW SÁCH ---
