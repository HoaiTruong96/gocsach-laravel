<div class="relative mt-20">
    <!-- SVG Wave Divider (Đường lượn sóng) -->
    ...
    <footer class="bg-[#2C3E36] text-white pt-16 pb-8 relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-300">
                        <li><a href="{{ route('home') }}" class="hover:text-white transition flex items-center gap-2"><i class="fas fa-angle-right text-xs"></i> Trang chủ</a></li>
                        <li><a href="#" class="hover:text-white transition flex items-center gap-2"><i class="fas fa-angle-right text-xs"></i> Về chúng tôi</a></li>
                        <li><a href="#" class="hover:text-white transition flex items-center gap-2"><i class="fas fa-angle-right text-xs"></i> Điều khoản sử dụng</a></li>
                        <li><a href="#" class="hover:text-white transition flex items-center gap-2"><i class="fas fa-angle-right text-xs"></i> Chính sách bảo mật</a></li>
                        <li><a href="#" class="hover:text-white transition flex items-center gap-2"><i class="fas fa-angle-right text-xs"></i> Liên hệ</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-300">
                        <li><a href="#" class="hover:text-white transition flex items-center gap-2"><i class="fas fa-book text-xs opacity-50"></i> Tiểu thuyết</a></li>
                        <li><a href="#" class="hover:text-white transition flex items-center gap-2"><i class="fas fa-book text-xs opacity-50"></i> Kinh tế & Kinh doanh</a></li>
                        <li><a href="#" class="hover:text-white transition flex items-center gap-2"><i class="fas fa-book text-xs opacity-50"></i> Tâm lý - Kỹ năng</a></li>
                        <li><a href="#" class="hover:text-white transition flex items-center gap-2"><i class="fas fa-book text-xs opacity-50"></i> Văn học kinh điển</a></li>
                        <li><a href="#" class="hover:text-white transition flex items-center gap-2"><i class="fas fa-book text-xs opacity-50"></i> Thiếu nhi</a></li>
                    </ul>
                </div>
            ...
            <div class="border-t border-gray-600/50 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-400">
                <p>Copyright © 2025 Mọt Sách Review. All rights reserved.</p>
