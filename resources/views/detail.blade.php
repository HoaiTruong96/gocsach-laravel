...
@section('content')
    {{-- Style riêng cho trang detail (nếu cần thiết) --}}
    <style>
        .line-clamp-3 {
            display: -webkit-box;
            -webkit-line-clamp: 3;
    ...
    <main class="container mx-auto px-4 py-12 flex-grow">
        ...
        {{-- Phần thông tin chính của sách (Hero Section) --}}
                    ...
                    @if($topReviews->count() > 0)
                        <div class="space-y-6">
                            @foreach($topReviews as $review)
                                <div class="bg-gray-50 p-6 rounded-xl border border-gray-100 transition hover:shadow-md">
                        ...
                        <div class="mt-8 text-center">
                            <a href="#" class="inline-block px-8 py-3 rounded-full border border-brand-green text-brand-green font-bold text-sm hover:bg-brand-green hover:text-white transition shadow-sm">
                                Xem tất cả đánh giá
                            </a>
                        </div>
                    @else
